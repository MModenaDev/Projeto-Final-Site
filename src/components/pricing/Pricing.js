        ...
        <div data-aos="fade-down" className="form-container__outer">
          <div className="form-container2 pricing__fix-width">
            <div className="form__card-container">
              <PriceCard title="Basic" description="Feito para quem busca simplicidade no seu dia-a-dia." price="599" styleTitle={{color: "#FF8514"}} user={this.props.user} getUser={this.props.getUser} {...this.props} styleBg={{backgroundColor: "#FF8514"}} arrowUrl={'/images/collapseArrowYellow.svg'} showArrow={this.state.showArrow} benefit1={"Primeiro benefício"} benefit2={"Segundo benefício"} benefit3={"Terceiro benefício"}/>
              <PriceCard title="Nomad" description="O melhor plano para quem quer flexibilidade em suas estadias." price="799" styleTitle={{color: "#D65A36"}} user={this.props.user} getUser={this.props.getUser} {...this.props} styleBg={{backgroundColor: "#D65A36"}} arrowUrl={'/images/collapseArrowOrange.svg'} showArrow={this.state.showArrow} benefit1={"Primeiro benefício"} benefit2={"Segundo benefício"} benefit3={"Terceiro benefício"}/>
              <PriceCard title="Explorer" description="Para quem deseja explorar o mundo com muito conforto." price="999" styleTitle={{color: "#BB2A00"}} user={this.props.user} getUser={this.props.getUser} {...this.props} styleBg={{backgroundColor: "#BB2A00"}} arrowUrl={'/images/collapseArrowDark.svg'} showArrow={this.state.showArrow} benefit1={"Primeiro benefício"} benefit2={"Segundo benefício"} benefit3={"Terceiro benefício"}/>
            </div>
          </div>
        </div>
      </div>
